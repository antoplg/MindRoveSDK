...
extern "C"
{
    ...
    SHARED_EXPORT int CALLING_CONVENTION get_heart_rate (double *ppg_ir, double *ppg_red, double *ppg_green,
        int data_size, int sampling_rate, int fft_size, double *rate);
    SHARED_EXPORT int CALLING_CONVENTION get_rmssd_hrv (const double *ppg_ir, const double *ppg_red, const double *ppg_green, 
        int data_size, int sampling_rate, double *out_rmssd);
