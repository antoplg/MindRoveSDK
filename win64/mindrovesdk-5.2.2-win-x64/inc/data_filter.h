...
public:
    ...
    */
    static std::pair<MindRoveArray<double, 2>, MindRoveArray<double, 1>> get_csp (
        const MindRoveArray<double, 3> &data, const MindRoveArray<double,1> &labels);
    // clang-format on
     ...
     */
    static std::pair<double *, double *> get_avg_band_powers (const MindRoveArray<double, 2> &data,
    ...
    static std::pair<double *, double *> get_custom_band_powers (
        const MindRoveArray<double, 2> &data, std::vector<std::pair<double, double>> bands,
        std::vector<int> channels, int sampling_rate, bool apply_filters);
    /**
     ...
     * @param ppg_ir input 1d array
     * @param ppg_red input 1d array
     * @param ppg_green input 1d array
     * @param data_len size of array
     * @param sampling_rate sampling rate
    ...
    static double get_heart_rate (
        double *ppg_ir, double *ppg_red, double *ppg_green, int data_len, int sampling_rate, int fft_size);
    /**
     ...
     */
    static double get_rmssd_hrv (
        const double *ppg_ir, const double *ppg_red, const double *ppg_green, int data_len, int sampling_rate);
    /// write file, in file data will be transposed
    static void write_file (
        const MindRoveArray<double, 2> &data, std::string file_name, std::string file_mode);
     ...
     */
    static std::tuple<MindRoveArray<double, 2>, MindRoveArray<double, 2>,
        MindRoveArray<double, 2>, MindRoveArray<double, 2>>
    perform_ica (
        const MindRoveArray<double, 2> &data, int num_components, std::vector<int> channels);
    /**
     * calculate ICA
     * @param data input 2d array, rows are samples
     * @param num_components number of components to find
    ...
    static std::tuple<MindRoveArray<double, 2>, MindRoveArray<double, 2>,
        MindRoveArray<double, 2>, MindRoveArray<double, 2>>
    perform_ica (const MindRoveArray<double, 2> &data, int num_components);
